...
Сервер доступен по адресу: https://grading.design.pages.academy/v1/escape-room/.

Спецификация по взаимодействию с сервером в формате OpenAPI — https://grading.design.pages.academy/spec/escape-room/v1.
